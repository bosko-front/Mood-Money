...
try {
    NoResultAnim = require('@/assets/gifs/SearchEmpty.json');
} catch {}
...
export default function EmptyState() {
    return (
        <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No insights found</Text>
        </View>
    );
}

const styles = StyleSheet.create({
    emptyContainer: { display:'flex', justifyContent: 'center', alignItems: 'center' },
